 ...
 * the License.
 */
package dk.orda.overlaynetwork.utils;
...
public class Utils {
    ...
    public static Number160 makeSHAHash(File file) {
        ...
        try {
            ...
            return new Number160(null, digest);
    ...
    public static Number160 createRandomNodeID() {
        ...
        byte[] me = new byte[20];
        random.nextBytes(me);
        Number160 id = new Number160(null, me);
        return id;
    }
...
//    }
     ...
     * {@link ByteBuffer} instance, or use com.google.common.io.ByteStreams#newDataOutput() to get a
     * growable buffer.
     */
...
//		return recipient.getIpv4Socket().getIpv4().equals(self.getIpv4Socket().getIpv4())
//				&& self.getIpInternalSocket() != null
//				&& recipient.getIpInternalSocket()!=null;
//	}
...
//	    	IPv4 a = self.calcInternalInetAddress(recipient.getIpInternalSocket().getIpv4());
//
//	    	return PeerSocket4Address.builder().ipv4(a)
//	    		.udpPort(recipient.getIpInternalSocket().getUdpPort())
//	    		.tcpPort(recipient.getIpInternalSocket().getTcpPort())
//	    		.udtPort(recipient.getIpInternalSocket().getUdtPort())
//	    		.build();
//	    }
//	    return null;
//    }
