...
public class ValueOrNodesHandler extends SimpleChannelInboundHandler<RpcMessages.ValueOrNodes> {
    private final Logger log = LoggerFactory.getLogger(this.getClass());

    private MessageQueue queue;

    public ValueOrNodesHandler(MessageQueue queue) {
        this.queue = queue;
    }

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, RpcMessages.ValueOrNodes msg) throws Exception {
