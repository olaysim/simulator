...
import dk.orda.overlaynetwork.utils.Pair;
import dk.orda.overlaynetwork.utils.Utils;
...
public final class Number160 extends Number implements Comparable<Number160> {
    ...
    // constants
    public static final Number160 ZERO = new Number160(null, 0);

    public static final Number160 ONE = new Number160(null,1);

    public static final Number160 MAX_VALUE = new Number160(null, new int[] { -1, -1, -1, -1, -1 });
     ...
     */
    public Number160(StatLogger statLogger, final int... val) {
        ...
        if (statLogger != null) {
            statLogger.addValue(new Value("hash", statLogger.getConfig().getTimestamp(), statLogger.getConfig(), "hash", Collections.singletonList((endtime-starttime))));
        }
    }
     ...
     */
    public Number160(StatLogger statLogger, final String val) {
        long starttime = System.nanoTime();
     ...
     *            long value
     */
    public Number160(StatLogger statLogger, final long val) {
        long starttime = System.nanoTime();
     ...
     *            byte array
     */
    public Number160(StatLogger statLogger, final byte[] val) {
        this(statLogger, val, 0, val.length);
    }
     ...
     *            the length to read
     */
    public Number160(StatLogger statLogger, final byte[] val, final int offset, final int length) {
        long starttime = System.nanoTime();
     ...
     */
    public Number160(StatLogger statLogger, final Random random) {
        long starttime = System.nanoTime();
     ...
     */
    public Number160(StatLogger statLogger, final long timestamp, Number160 number96) {
        long starttime = System.nanoTime();
     ...
     */
    public Number160 number96(StatLogger statLogger) {
        return new Number160(statLogger, 0, 0, this.val[2], this.val[3], this.val[4]);
    }
     ...
     */
    public Number160 xor(StatLogger statLogger, final Number160 key) {
        final int[] result = new int[INT_ARRAY_SIZE];
        for (int i = 0; i < INT_ARRAY_SIZE; i++) {
            result[i] = this.val[i] ^ key.val[i];
        }
        return new Number160(statLogger, result);
    }
     ...
     */
    public static Number160 createHash(StatLogger statLogger, final int integerValue) {
        Random r = new Random(integerValue);
        return new Number160(statLogger, r);
    }
     ...
     */
    public static Number160 createHash(StatLogger statLogger, final long longValue) {
     ...
     */
    public static Number160 createHash(StatLogger statLogger, final String string) {
        long starttime = System.nanoTime();
        Number160 number160 = Utils.makeSHAHash(string);
        long endtime = System.nanoTime();
        if (statLogger != null) {
            statLogger.addValue(new Value("hash", statLogger.getConfig().getTimestamp(), statLogger.getConfig(), "hash", Collections.singletonList((endtime-starttime))));
        }
	...
	public static Pair<Number160, Integer> decode(StatLogger statLogger, byte[] me, int offset) {
		Number160 number160 = new Number160(statLogger, me, offset, 20);
		return new Pair<Number160, Integer>(number160, offset + 20);
	}

	public static Number160 decode(StatLogger statLogger, ByteBuf buf) {
		return new Number160(statLogger, buf.readInt(), buf.readInt(), buf.readInt(), buf.readInt(), buf.readInt());
	}
